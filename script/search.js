function createPgNumSearch(number){
    ...
    num.setAttribute('href','http://localhost:3000/FirstProject/html/search.html')
    ...
    document.getElementById('page'+number).addEventListener('click',function(){
        localStorage.setItem('page_number-search',number)
    })
}

function redirLinkSearch(characters,index,page){
    const link = document.createElement('a')
    link.setAttribute('href','http://localhost:3000/FirstProject/html/result.html')
...
function redirImgSearch(characters,index,page){
    const link = document.createElement('a')
    link.setAttribute('href','http://localhost:3000/FirstProject/html/result.html')
...
function createCharacter(characters,page){
    ...
    for(index;index<n;index++){
        ...
        redirImgSearch(characters,index,page_number)
        redirLinkSearch(characters,index,page_number)
